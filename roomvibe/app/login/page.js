    ...
    <main>
      ...
      <form action="" className="flex flex-col gap-3">
        {/* login with email */}
          ...
          />
       <p className="text-sm pb-5">Don&apos;t have an account. <Link href="/" className="underline text-[#fd7e14]">Create an account</Link></p>
       <input type="submit" value="Login" className="bg-[#fd7e14] p-3 text-3xl font-bold rounded-md"/>
      </form>
    </section>
    </main>
  );
