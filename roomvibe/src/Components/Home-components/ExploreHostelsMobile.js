...
export default function ExploreHostelsMobile (){
  return (
    <section className="flex flex-col lg:hidden gap-5 pt-5 px-2 h-[80vh] overflow-scroll relative top-40 bottom-40 py-16">
      <div className="w-full flex gap-8 border-b-[1px] border-t-[1px] border-slate-300 py-5">
      ...
      <div className="w-full flex gap-8 border-b-[1px] border-slate-300 py-5">
        <Image src={Hostel1} alt="Green Hostel" width={150} className="rounded-lg"/>
        <div>
          <h1 className="text-xl font-semibold">Green Hostel</h1>
          <p className="text-sm text-gray-500 font-semibold">AAMUSTED - Tanoso</p>
